...
OneWireThermometer::OneWireThermometer(bool crcOn, bool useAddr, bool parasitic, byte pin, int device_id) :
    useCRC(crcOn),
	useAddress(useAddr),
	useParasiticPower(parasitic),
...
/*
** each time I get to where i'm liking Arduino C++ I run into some bullshit like this...
** If i move the code to the main stub, where it belongs, I get some other bullshit error.
